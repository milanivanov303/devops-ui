<template>
  <div>
    <button class="waves-effect waves-light btn-small modal-trigger"
            data-target="register">
            <i class="material-icons left">assignment_ind</i>Schedule a demo
    </button>
    <div id="register" ref="register-demo-modal" class="modal right-sheet">
        ...
        <div class="row">
          <form @submit.prevent="onSubmit">
            ...
            <div class="row">
              ...
              <div class="validator col s12 m5 l5 offset-l1 offset-m1">
                <div class="red-text" v-if="$v.business.error">
            ...
            <div class="row">
              ...
              <div class="validator col s12 m5 l5 offset-l1 offset-m1">
                <div class="red-text" v-if="$v.startDate.error || $v.endDate.error">
            ...
            <div class="row">
              ...
              <div class="validator col s12 m5 l5 offset-l1 offset-m1">
                <div class="red-text" v-if="$v.startTime.error || $v.endTime.error">
            ...
            <div class="row">
              ...
              <div class="input-field col s12 m6 l6">
                <a href="#!" class="modal-close waves-effect waves-blue btn-flat left">Close</a>
              </div>
            </div>
          </form>
        </div>
