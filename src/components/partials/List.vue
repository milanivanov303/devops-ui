        ...
        <div class="col s12 l6 left">
            <table class="responsive">
                <caption>
                    ...
                    <a class="waves-effect waves-light btn-small left"
                       @click="selectAvailable(filteredItems)">
        ...
        <div class="col s12 l6 right" >
            <table class="responsive">
                <caption>
                    ...
                    <a class="waves-effect waves-light btn-small left"
                       @click="removeSelected(filteredSelectedItems)">
...
export default {
  ...
  mounted() {
    ...
    if (this.selected) {
      this.selectedItems = this.items.filter(item => this.selected.find(i => i.id === item.id));
    }
  },
  methods: {
    getGroupedBy(items) {
