        ...
        <div class="card-content">
          ...
          <div class="row">
            <div class="col s12 m8">
              ...
              <div class="row">
                <div class="col s12 center">
                  <button v-if="!isLoggingIn" @click="login()" class="btn waves-effect waves-light w-100">
                    Login
                  </button>
                  <div v-if="isLoggingIn" class="preloader-wrapper small active">
            ...
            <div class="col s12 m4 center">
              ...
              <button v-if="!isLoggingInSSO" class="btn waves-effect waves-light w-100" @click="loginSSO()">
                Login with SSO
              </button>
