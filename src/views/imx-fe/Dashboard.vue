...
export default {
  ...
  methods: {
    ...
    buildsGroupedByBranch() {
      ...
      this.$store.getters['builds/getBuildsGroupedByBranch']('imx-fe').forEach((groupedBuild) => {
    ...
    buildsGroupedByUser() {
      ...
      this.$store.getters['builds/getBuildsGroupedByUser']('imx-fe').forEach((groupedBuild) => {
